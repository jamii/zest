...
pub const BuiltinTyped = union(enum) {
    ...
    pub fn hasSideEffects(builtin: BuiltinTyped) bool {
        return switch (builtin) {
            .dummy, .equal_i64, .not_equal_i64, .less_than_i64, .less_than_or_equal_i64, .more_than_i64, .more_than_or_equal_i64, .add_u32, .add_i64, .subtract_u32, .subtract_i64, .multiply_u32, .multiply_i64, .remainder_u32, .remainder_i64, .memory_size, .heap_start, .size_of => false,
